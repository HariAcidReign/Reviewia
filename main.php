...
<html lang="en">
	...
	<body>
		<div class="min-w-screen min-h-screen bg-gray-200">
			...
			>
				...
				>
					...
					>
						...
						<a href="siteRating.php" class="bg-pink-500 ml-5 text-white active:bg-pink-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:bg-pink-600 outline-none focus:outline-none transition-all duration-150 ease"> Rate our site!</a>
					</nav>
					<a
			...
			>
				<button
					class="text-red-400 bg-transparent border border-solid border-red-600 hover:bg-red-400 hover:text-white active:bg-purple-600 font-bold uppercase px-8 py-3 rounded-full outline-none focus:outline-none mr-1 mb-1"
					type="button"
...
mysqli_connect("localhost","root","") or die(mysql_error());
  ...
  $query1="SELECT * FROM hotel_details ORDER BY name";
  ...
  echo'<br><h3
					...
					>
						...
						<span class="text-green-400">Hotels</span>
					</h3>';
  while($row = $result1->fetch_assoc()) {
    ...
    echo '
						<div
							class="p-16 transition-all duration-150 bg-white rounded-lg shadow-xl ease hover:shadow-2xl"
						>
							<div class="mb-2 pb-2">
...
$query2="SELECT * FROM attraction_details ORDER BY name";
  ...
  echo'<br><h3
					...
					>
						...
						<span class="text-green-400">Attractions</span>
					</h3>';
  ...
  while($row = $result2->fetch_assoc()) {
    ...
    echo '
						...
						>
							...
							<div class="mt-3 mb-6 text-center">
								<h5 class="pb-2 text-xl font-extrabold leading-6 text-red-500">'.$row["name"].'</h5>
								
								<h6 class="pb-2 text-s  leading-6 text-gray-900">'.$row["location"].'</h6>
								<br />
								<button 
									class="text-red-500 bg-transparent border border-solid border-gray-900 hover:bg-blue-500 hover:text-white active:bg-red-600 font-bold uppercase px-4 py-2 rounded-full outline-none focus:outline-none mr-1 mb-1"
									type="button"
									style="transition: all 0.15s ease"
								><a href="show.php?name='.$row['name'].'">
									More Information
