...
mysqli_connect("localhost","root","") or die(mysql_error());
  ...
  $query1="SELECT * FROM hotel_details NATURAL JOIN hotel_category where category='national' ";
  ...
  echo'<br><h3
					...
					>
						...
						<span class="text-purple-500">National Places</span>
					</h3><br>';
echo'<br><h4
...
$query2="SELECT * FROM attraction_details NATURAL JOIN attraction_category where category='national'";
