		...
		<div class="flex items-center justify-center h-screen bg-red-200 sm:px-6">
			...
			<div class="w-full max-w-sm p-4 bg-gray-200 rounded-md shadow-md sm:p-6">
				<div class="flex items-center justify-center">
					<span class="text-xl  font-medium text-gray-900">Add Attraction</span>
				</div>
				<form action=addattraction.php class="mt-4" method="post">
					<label for="place-id" class="block">
						<span class="text-sm text-gray-900">Attraction-ID</span>
						<input
							id="place-id"
							name="place-id"
					...
					<label for="name" class="block">
						<span class="text-sm text-gray-900">Attraction Name</span>
						<input
					...
					<label for="otime" class="block">
						<span class="text-sm text-gray-900">Open-Time</span>
						<input
							type="time"
							id="otime"
							name="otime"
...
if(isset($_POST['submit']))
{
	...
	$query1="INSERT  INTO attraction_details VALUES('$place_id','$name','$location','$otime','$ctime')";
	mysqli_query($con,$query1);
	$query2="INSERT  INTO attraction_category VALUES('$place_id','$location','$category')";
